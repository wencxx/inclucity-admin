...
const downloadPDF = () => {
    ...
    pdf.setFontSize(10);
    pdf.text("This table contains a detailed list of the PWD ID Applicants. The table contains their Application Number, Full Name, Email, Age, Phone Number, Gender, Barangay and Application Date.", 10, 117, { maxWidth: 190 });
